...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Xylophone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Xylophone11AppDelegate")
...
SWIFT_CLASS("_TtC9Xylophone13SceneDelegate")
...
SWIFT_CLASS("_TtC9Xylophone14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)keyPressed:(UIButton * _Nonnull)sender;
